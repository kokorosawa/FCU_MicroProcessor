...
void Init_ADC(void)
{
	ADC_Open(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)), (0UL<<10), (3UL<<2), (1UL << 7));
...
void Init_PWM(void)
{ 
	PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), 0x0, 50, 50);
	PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), (1UL));
	PWM_Start(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), (1UL));
}
